...
const ProductForm = () => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<TPro>({
    defaultValues: {
      price: 10,
      stock: 1
    }
...
<div className="container mx-auto p-6 bg-gray-100 rounded-lg shadow-md lg:my-28 lg:w-2/4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          {errors.category && <span className="text-red-600">Product Category is required</span>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
          {errors.stock && <span className="text-red-600">Stock is required</span>}
        </div>
